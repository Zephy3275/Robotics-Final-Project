Smart Object Recognition Robot is a vision-based robotics project that uses MobileNetV2 and TensorFlow Lite to classify four custom objects — Book, Newspaper, Zip-top Can, Old School Bag — and translate those detections into real-world motor actions on a Raspberry Pi 4.
